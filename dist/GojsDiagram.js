...
var GojsDiagram = /** @class */ (function(_super) {
    ...
    function GojsDiagram(props) {
        ...
        _this.modelChangedHandlers = [
            ...
            new modelChangedhandler_1.BeginTransactionHandler(),
    ...
    GojsDiagram.prototype.dragOverHandler = function(evt) {
        evt.preventDefault();
        return false;
    };
    ...
    GojsDiagram.prototype.applyAddRemoveNodesFromModel = function() {
        ...
        var nodesToAdd = this.props.model.nodeDataArray
            .filter(function(e) {
                return (
                    _this.myDiagram.model.nodeDataArray.findIndex(function(el) {
                        return el.key === e.key;
                    }) === -1
                );
            })
        ...
        var nodesToRemove = this.myDiagram.model.nodeDataArray.filter(function(e) {
            return (
                _this.props.model.nodeDataArray.findIndex(function(el) {
                    return el.key === e.key;
                }) === -1
            );
        });
